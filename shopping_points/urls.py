...
# router.register('withdrawpoi', PointWithdrawViewSet)
...
# router.register('point', UserPointChangeRecordViewSet)
router.register('receipt_account', ReceiptAccountViewSet)
# router.register('transfer', TransferBalanceRecordViewSet)
# router.register('serviceconfig', ServiceConfigViewSet)
