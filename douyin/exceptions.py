...
class TikTokClientException(TikTokException):
    """WeChat API client exception class"""

    def __init__(self, errcode, errmsg, client=None,
                 request=None, response=None):
        super(TikTokException, self).__init__(errcode, errmsg)
        self.client = client
...
class InvalidSignatureException(TikTokException):
...
class APILimitedException(TikTokClientException):
    """WeChat API call limited exception class"""
    pass


class InvalidAppIdException(TikTokClientException):
...
class TikTokPayException(TikTokClientException):
    """TikTok Pay API exception class"""
    ...
    def __init__(self, return_code, result_code=None, return_msg=None,
        ...
        :param errmsg: 错误代码描述
        """
        super(TikTokException, self).__init__(
            errcode,
            errmsg,
            client,
            request,
