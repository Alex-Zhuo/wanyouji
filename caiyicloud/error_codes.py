...
class CaiyiRequestFrequencyException(CaiyiSystemException):
    ...
    def __init__(self, request_data: Optional[dict] = None, response_data: Optional[dict] = None):
        super().__init__(CaiyiErrorCode.REQUEST_FREQUENCY_TOO_HIGH, request_data=request_data, response_data=response_data)
...
class CaiyiSignatureException(CaiyiSystemException):
    """API签名验证失败异常"""
    def __init__(self, request_data: Optional[dict] = None, response_data: Optional[dict] = None):
        super().__init__(CaiyiErrorCode.API_SIGNATURE_VERIFICATION_FAILED, request_data=request_data, response_data=response_data)
...
class CaiyiDuplicateOrderException(CaiyiSystemException):
    """重复下单异常"""
    def __init__(self, request_data: Optional[dict] = None, response_data: Optional[dict] = None):
        super().__init__(CaiyiErrorCode.DISTRIBUTOR_ORDER_MAPPING_EXISTS, request_data=request_data, response_data=response_data)
...
class CaiyiTicketNotFoundException(CaiyiProgramException):
    """票价信息不存在异常"""
    def __init__(self, request_data: Optional[dict] = None, response_data: Optional[dict] = None):
        super().__init__(CaiyiErrorCode.TICKET_PRICE_INFO_QUERY_EXCEPTION, request_data=request_data, response_data=response_data)


class CaiyiSeatNotFoundException(CaiyiProgramException):
    """座位信息不存在异常"""
    def __init__(self, request_data: Optional[dict] = None, response_data: Optional[dict] = None):
        super().__init__(CaiyiErrorCode.SEAT_INFO_QUERY_EXCEPTION, request_data=request_data, response_data=response_data)


class CaiyiBundleTicketNotFoundException(CaiyiProgramException):
    """套票信息不存在异常"""
    def __init__(self, request_data: Optional[dict] = None, response_data: Optional[dict] = None):
        super().__init__(CaiyiErrorCode.BUNDLE_TICKET_INFO_NOT_FOUND, request_data=request_data, response_data=response_data)
