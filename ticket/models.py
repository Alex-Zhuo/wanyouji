...
class TicketFile(models.Model):
    ...
    create_at = models.DateTimeField('创建时间', auto_now_add=True)
    is_tiktok = models.BooleanField('是否推送到抖音', default=False)
    is_ks = models.BooleanField('是否推送到快手', default=False)
    is_xhs = models.BooleanField('是否推送到小红书', default=False)
    push_xhs = models.BooleanField('是否已经推送小红书', default=False)
