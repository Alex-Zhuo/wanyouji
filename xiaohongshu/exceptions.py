...
class XhsClientException(XhsException):
    """WeChat API client exception class"""

    def __init__(self, errcode, errmsg, client=None,
                 request=None, response=None):
        super(XhsException, self).__init__(errcode, errmsg)
        self.client = client
...
class InvalidSignatureException(XhsException):
...
class APILimitedException(XhsClientException):
    """WeChat API call limited exception class"""
    pass


class InvalidAppIdException(XhsClientException):
...
class XhsPayException(XhsClientException):
    ...
    def __init__(self, return_code, result_code=None, return_msg=None,
        ...
        :param errmsg: 错误代码描述
        """
        super(XhsException, self).__init__(
            errcode,
            errmsg,
            client,
            request,
